            ...
            <div className="rounded-2xl bg-brand-dark p-6 text-white sm:p-8">
              ...
              <div className="mt-6 space-y-5">
                <a
                  ...
                  className="flex items-start gap-3 transition-colors hover:text-brand-primary-hover"
                >
                ...
                <a
                  ...
                  className="flex items-center gap-3 transition-colors hover:text-brand-primary-hover"
                >
